          ...
          <table className="w-full text-[11px]">
            <thead className="sticky top-0">
              <tr className="ehr-chrome-gradient-deep">
                <th className="text-left px-2 py-1 border border-gray-400 ehr-chrome-gradient sticky left-0 z-10 min-w-[100px]">Vital Sign</th>
                <th className="text-center px-2 py-1 border border-gray-400 ehr-chrome-gradient min-w-[50px]">Trend</th>
                {vitals.map((reading) => (
            ...
            <tbody>
              {vitalSigns.map((vital, vitalIdx) => (
                <tr key={vital.key} className={vitalIdx % 2 === 0 ? 'bg-white' : 'ehr-surface-alt'}>
                  ...
                  {vitals.map((reading, readingIdx) => {
                    ...
                    return (
                      <td
                        key={reading.id}
                        className="px-2 py-1 border border-gray-300 text-center cursor-pointer ehr-hoverable"
