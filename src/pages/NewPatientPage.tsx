...
function Field({ label, htmlFor, required, error, children }: FieldProps) {
  return (
    <div className="flex flex-col">
      <label htmlFor={htmlFor} className="ehr-label mb-0.5">
        {label}
        ...
        >
          ...
          <fieldset className="ehr-fieldset">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              ...
              <Field label="Middle Name" htmlFor="middleName" error={errors.middleName}>
                <input
                  id="middleName"
                  type="text"
                  className="ehr-input w-full"
          ...
          <fieldset className="ehr-fieldset">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <Field label="Mobile Phone" htmlFor="phoneMobile" error={errors.phoneMobile}>
                <input
                  id="phoneMobile"
                  type="tel"
                  className="ehr-input w-full"
              ...
              <Field label="Home Phone" htmlFor="phoneHome" error={errors.phoneHome}>
                <input
                  id="phoneHome"
                  type="tel"
                  className="ehr-input w-full"
              ...
              <Field label="Work Phone" htmlFor="phoneWork" error={errors.phoneWork}>
                <input
                  id="phoneWork"
                  type="tel"
                  className="ehr-input w-full"
          ...
          <fieldset className="ehr-fieldset">
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-3">
              <div className="md:col-span-6">
                <Field label="Street Address" htmlFor="street1" error={errors.street1}>
                  <input
                    id="street1"
                    type="text"
                    className="ehr-input w-full"
