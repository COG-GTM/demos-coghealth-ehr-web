...
function App() {
  ...
  return (
    <BrowserRouter>
      <div className="h-screen flex flex-col" style={{ background: 'var(--ehr-app-bg)', fontFamily: 'Tahoma, sans-serif' }}>
        <Navigation 
        ...
        <div className="h-5 bg-gradient-to-b from-[var(--ehr-statusbar-bg)] to-[var(--ehr-app-bg)] border-t border-gray-400 flex items-center justify-between px-2 text-[10px] text-gray-600">
