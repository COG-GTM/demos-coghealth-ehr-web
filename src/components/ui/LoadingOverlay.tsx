...
export function LoadingOverlay({ isLoading, text = 'Loading...' }: LoadingOverlayProps) {
  ...
  return (
    <div className="absolute inset-0 z-40 flex items-center justify-center pointer-events-auto bg-white/60 backdrop-blur-sm">
      <div className="flex flex-col items-center bg-white rounded-xl shadow-lg px-8 py-6 border border-gray-100">
        <div className="w-8 h-8 mb-3 rounded-full border-2 border-gray-200 border-t-[#5e6ad2]" style={{ animation: 'spin 0.8s linear infinite' }} />
