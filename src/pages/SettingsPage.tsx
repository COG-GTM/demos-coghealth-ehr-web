...
export default function SettingsPage() {
  ...
  const handleSave = () => {
    localStorage.setItem(STORAGE_KEY, JSON.stringify({ profile, notifications, appearance: { ...appearance, theme: themeMode } }));
    setSaved(true);
                  ...
                  {(['light', 'dark', 'system'] as ThemeMode[]).map((theme) => (
                    ...
                    >
                      {(() => {
                        ...
                        return <Icon className="w-4 h-4 mx-auto mb-1 text-gray-600" />;
                      })()}
